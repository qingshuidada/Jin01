		...
		rownumbers:"true",
		   ...
		   columns:[[
             {field:"_op",title:"管理",width:100,resizable:true,align:"center",sortable:true,formatter:function(value,row,index){
		       ...
		       {field:"dateStr",title:"登记日期",fitColumns:true,resizable:true,align:"center",sortable:true,width:120},
		       {field:"departmentName",title:"部门",fitColumns:true,resizable:true,align:"center",sortable:true,width:120,formatter:function(value,row,index){
					var type = row.type;
					if(type == '1'){
		       ...
		       {field:"userName",title:"姓名",fitColumns:true,resizable:true,align:"center",sortable:true,width:100,formatter:function(value,row,index){
					var type = row.type;
					if(type == '1'){
						return value;
					}else if(type == '2'){
		       ...
		       {field:"reason",title:"扣奖原因",fitColumns:true,resizable:true,align:"center",sortable:true,width:100},
		       {field:"amount",title:"扣奖金额",fitColumns:true,resizable:true,align:"center",sortable:true,width:100},
		       {field:"executorName",title:"执行人",fitColumns:true,resizable:true,align:"center",sortable:true,width:100},
