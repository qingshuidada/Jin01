...
(function(w){
	...
	function div(ob){
		this.cj=function(){
			...
			this.G_d.style.backgroundColor='#E0ECFF';
			//#E0ECFF
			this.iecss='';
			...
			if(typeof(ob.css)=='string'){
				...
				this.G_d.style.backgroundColor='#E0ECFF';//改动
				this.G_d.className=ob.css;
				if(ob.css=='ui_confirm'){			
					this.G_d.innerHTML='<div class="panel-header panel-header-noborder window-header" style="width: 238.4px;background:none;"><div class="panel-title">提示</div><div class="panel-tool"><a class="panel-tool-close"></a></div></div>'+
